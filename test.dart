...
//  }
  ...
  // other providers.
  final smtpServer = gmail(username, "Comcast99!");
...
//      (attachments ?? []).map((a) => FileAttachment(File(a)));
  ...
  final message = Message()
    ..from = Address('vishalcomcast99@gmail.com', 'My name 😀')
    ..recipients.addAll(["rvishal494@gmail.com"])
    //..ccRecipients.addAll(["vishalcomcast99@gmail.com"])
    // ..bccRecipients.addAll(["rvishal494@gmail.com"])
