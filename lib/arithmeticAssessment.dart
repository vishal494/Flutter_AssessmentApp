...
AptitudeQuestions aptitudeQuestions = AptitudeQuestions();
//Brains brain = Brains();

class ArithmeticAssessment extends StatefulWidget {
  @override
  _ArithmeticAssessmentState createState() => _ArithmeticAssessmentState();
}

bool arithmeticResult = false;

class _ArithmeticAssessmentState extends State<ArithmeticAssessment> {
  ...
  void questionsToBeAsked() {
    ...
    aptitudeQuestions.arithmeticNumbGenerator(numberOfQuestions);
  }
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Arithmetic Assessment'),
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                ...
                child: AutoSizeText(
                  aptitudeQuestions.getQuestionText(),
                  maxLines: 9,
                  minFontSize: 30.0,
                  style: TextStyle(
                      color: Colors.white,
                ...
                setState(() {
                  if (statusText == 'Next Section') {
                    ...
                    if (currentSelectedLabel != null &&
                      ...
                      //print(aptitudeQuestions.getRightAnswer());
                      if (currentSelectedLabel ==
                          aptitudeQuestions.getRightAnswer()) {
                        counter++;
                        //print('pass');
                      }
                      if (aptitudeQuestions.isFinished()) {
                      ...
                      aptitudeQuestions.nextQuestion();
  ...
  List<Widget> options() {
    ...
    for (int i = 0; i < aptitudeQuestions.getChoices().length; i++) {
            ...
            onPressed: () {
              setState(() {
                ...
                currentSelectedLabel =
                    aptitudeQuestions.getChoices()[currentSelectedOption];
              });
            },
            child: Text(
              aptitudeQuestions.getChoices()[i],
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 30.0,
                color: currentSelectedLabel == aptitudeQuestions.getChoices()[i]
                    ? Colors.amberAccent
  ...
  _onAlertButtonPressed(context) {
    Alert(
      ...
      title: "Done with Aptitude Assessment",
      desc: "Thank You..!",
      buttons: [
        DialogButton(
            child: Text(
